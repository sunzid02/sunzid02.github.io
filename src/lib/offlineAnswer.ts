...
import type { ChatReply, QuickAction } from "./chatTypes";
...
/**
 * Offline answer generator (works without API).
 * Uses siteModel + simple intent rules.
 */
export function answerOffline(userMessage: string): ChatReply {
  ...
  if (msg.includes("skill") || msg.includes("stack") || msg.includes("tech") || msg.includes("tools")) {
  ...
  return {
    answer: "Ask me about my summary, skills, experience, projects, or contact info.",
    quickActions: quickDefaults,
  };
}
