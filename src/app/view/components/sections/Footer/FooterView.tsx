...
export default function FooterView({ contact, brand }: Props) {
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li>
                <button onClick={() => scrollToSection('stack')} className="footer-link">
                  Tech Stack
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('experience')} className="footer-link">
                  Experience
                </button>
              </li>
              <li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li>
                <button onClick={() => scrollToSection('creator')} className="footer-link">
                  Content
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('travel')} className="footer-link">
                  Travel
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('recommendations')} className="footer-link">
                  Recommendations
                </button>
              </li>
              <li>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="footer-copyright">
              © {currentYear} {brand.name}. Built with React & TypeScript.
            </p>
